...
const UpdateSupplier = () => {
    ...
    const initBreadcrumb = [
        ...
        { name: '供應商', href: '/admin/supplier', current: false },
    ]
    ...
    useEffect(() => {
        if (token !== undefined && token.length > 0) {
            ...
            setBreadcrumbs((prev) => {
                return [...prev, { name: '新增供應商', href: '/admin/supplier/update', current: true }]
            })
        }
        ...
        return (
            <div className='p-4'>
                <main className="isolate">
                    ...
                    <h2 className="text-Primary-300 text-center text-4xl font-bold mb-8">{formData.name.length === 0 ? '新增供應商' : formData.name}</h2>
                </main>
