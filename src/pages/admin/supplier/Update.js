...
const UpdateSupplier = () => {
    ...
    const getOne = async (accessToken, token, scenario) => {
        ...
        setBreadcrumbs((prev) => {
            return scenario === 'create' ? [...initBreadcrumb, { name: '新增供應商', href: '/admin/supplier/update', current: true }] : [...initBreadcrumb, { name: data.data.name, href: '/admin/supplier/update', current: true }]
        })
