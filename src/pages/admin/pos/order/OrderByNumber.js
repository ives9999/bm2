...
export function OrderByNumber() {
    ...
    const getData = async (accessToken) => {
        const data = await getOrderByNumberAPI(accessToken, uid);
        console.info(data);
    ...
    return (
        <div className='p-4'>
            ...
            <h2 className='text-MyWhite text-3xl mb-4 flex justify-center'>由訂單編號匯入訂單</h2>
            <div>
                <div className="">
                    <Input
                        label="pos 編號"
                ...
                <PrimaryButton type="button" className="w-full lg:w-60 mt-6" onClick={SyncStart}>匯入</PrimaryButton>
            </div>
