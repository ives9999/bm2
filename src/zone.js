...
// var city, area, road;
// var myCity, myArea, myRoad;
// function setMyCity(v){
//     myCity = v;
// }
// function setMyArea(v){
//     myArea = v;
// }
// function setMyRoad(v){
//     myRoad = v;
// }
// //第一個選項
// function first(){
...
//     return o;
// }
// function makeCity(obj){
//     obj.options.add(first());
//     for(var i in citys){
//         o = document.createElement('option');
//         o.text = citys[i].name;
//         o.value = citys[i].id;
//         if (citys[i].id == myCity){
//             o.selected = true;
//         }
//         obj.options.add(o);
//     }
// }
// function makeArea(obj, city){
//     obj.innerHTML = '';
//     obj.options.add(first());
...
//         for (var i in areas) {
//             if (areas[i].city == city) {
//                 thisAreas.push(areas[i]);
//             }
//         }
//         for (var i in thisAreas) {
//             o = document.createElement('option');
//             o.text = thisAreas[i].name;
//             o.value = thisAreas[i].id;
//             if (thisAreas[i].id == myArea) {
//                 o.selected = true;
//             }
//             obj.options.add(o);
//         }
